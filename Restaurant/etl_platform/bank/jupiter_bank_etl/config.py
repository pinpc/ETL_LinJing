...
FIBU_RULES = [
    ...
    (re.compile(r"Jing\s*Ling|JING\s*LING", re.I), "H", "1890", "Ling Jing Privat"),
    ...
    (re.compile(r"Ling\s+Jing.*Privat|Privat.*Ling\s+Jing|Ling\s+Jin.*Privat", re.I), "H", "1890", "Ling Jing Privat"),
    (re.compile(r"Ze\s+Peng.*(Zurückzahlung|Darlehen|rueckzahlung|Rückzahlung)", re.I), "S", "1707", "Ze Peng  Darlehenrückzahlung"),
    ...
    (re.compile(r"Munch\s+Energie", re.I), "S", "904240", "Munch Energie GmbH + Co. KG Strom"),
    (re.compile(r"MONTANA\s+AB|Montana", re.I), "S", "904240", "MONTANA AB Gas"),
    ...
    (re.compile(r"toom\s+BM|TOOM\s+BM", re.I), "S", "904280", "toom BM Muenchen Bodenbelag"),
    ...
    (re.compile(r"\bADSA\b", re.I), "S", "900480", "ADSA"),
    ...
    (re.compile(r"Paulaner", re.I), "H", "3400", "Paulaner Getraenke"),
    ...
    (re.compile(r"Erstattung Lohnkosten", re.I), "S", "1361", "an Sparkasse Allgäu"),
