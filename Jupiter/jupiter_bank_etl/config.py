...
FIBU_RULES = [
    ...
    (re.compile(r"AOK Bayern", re.I), "S", "1743", "AOK Bayern Beitrag"),
    (re.compile(r"BGN", re.I), "S", "4138", "BGN Beitrag"),
    (re.compile(r"M-net", re.I), "S", "904250", "M-net Internet"),
    (re.compile(r"\bMiete\b", re.I), "S", "4210", "Miete"),
    (re.compile(r"Erstattung Lohnkosten", re.I), "S", "1361", "Erstattung Lohnkosten Jupiter"),
